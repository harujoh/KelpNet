...
##特徴
- 行列を使わず配列ループだけで実装しているので Deep Learning の仕組みを把握するための学習コストを抑えることが出来ます。
- 全てC#で記述されており、また依存する外部ライブラリが無いため、どこで何をしているかを全て観測できます。
- 『Chainer』や『Keras』また『Torch』のように、関数を書き連ねるように記述する直感的なコーディングスタイルを採用しています。
