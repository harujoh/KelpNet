    ...
    class Test14
    {
        ...
        public static void Run()
        {
            ...
            FunctionStack nn = new FunctionStack(
                ...
                new Convolution2D(1, 32, 5, pad: 2, name: "l1 Conv2D"),new ReLU(name: "l1 ReLU", isGpu: false),

                new MaxPooling(2, 2, name: "l1 MaxPooling"),

                //new Convolution2D(32, 64, 5, pad: 2, name: "l2 Conv2D", activation: new ReLU(name: "l2 ReLU")),
                new Convolution2D(32, 64, 5, pad: 2, name: "l2 Conv2D"),new ReLU(name: "l2 ReLU", isGpu: false),

                new MaxPooling(2, 2, name: "l2 MaxPooling"),

                //new Linear(7 * 7 * 64, 1024, name: "l3 Linear", activation: new ReLU(name: "l3 ReLU")),
                new Linear(7 * 7 * 64, 1024, name: "l3 Linear"),new ReLU(name: "l3 ReLU", isGpu: false),
